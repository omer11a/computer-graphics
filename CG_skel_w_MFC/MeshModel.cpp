...
PrimMeshModel::PrimMeshModel() : MeshModel()
{
	...
	coordinates.push_back(vec2(0.0f, 1.0f));
	coordinates.push_back(vec2(0.25f, 1.0f));
	coordinates.push_back(vec2(0.0f, 2.0f / 3));
	coordinates.push_back(vec2(0.25f, 2.0f / 3));
	coordinates.push_back(vec2(0.0f, 1.0f / 3));
	coordinates.push_back(vec2(0.25f, 1.0f / 3));
	coordinates.push_back(vec2(0.0f, 0.0f));
	coordinates.push_back(vec2(0.25f, 0.0f));
	coordinates.push_back(vec2(0.5f, 2.0f / 3));
	coordinates.push_back(vec2(0.5f, 1.0f / 3));
	coordinates.push_back(vec2(0.75f, 2.0f / 3));
	coordinates.push_back(vec2(0.75f, 1.0f / 3));
	coordinates.push_back(vec2(1.0f, 2.0f / 3));
	coordinates.push_back(vec2(1.0f, 1.0f / 3));
	...
	// back face
	faces.push_back(istringstream("1/12/2  7/9/2  5/10/2"));
	faces.push_back(istringstream("1/12/2  3/11/2  7/9/2"));
	// left face
	faces.push_back(istringstream("1/12/6  4/13/6  3/11/6"));
	faces.push_back(istringstream("1/12/6  2/14/6  4/13/6"));
	// top face
	faces.push_back(istringstream("3/1/3  8/4/3  7/2/3"));
	faces.push_back(istringstream("3/1/3  4/3/3  8/4/3"));
	// right face
	faces.push_back(istringstream("5/10/5  7/9/5  8/4/5"));
	faces.push_back(istringstream("5/10/5  8/4/5  6/6/5"));
	// bottom face
	faces.push_back(istringstream("1/7/4  5/8/4  6/6/4"));
	faces.push_back(istringstream("1/7/4  6/6/4  2/5/4"));
	// front face
	faces.push_back(istringstream("2/5/1  6/6/1  8/4/1"));
	faces.push_back(istringstream("2/5/1  8/4/1  4/3/1"));
